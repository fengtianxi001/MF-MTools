...
class FileCategory {
	constructor() {
		...
		this.json = path.resolve(baseURL, './data/fileCategory.json')
		this.initData()
	}
	initData() {
		//数据初始化
		...
		//默认值
		const defaultValue = [
			{ label: '文件分类一', id: uuidv4(), color: '#282c34' },
			{ label: '文件分类二', id: uuidv4(), color: '#3042d2' },
			{ label: '文件分类三', id: uuidv4(), color: '#3042d2' },
		]
